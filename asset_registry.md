...
| **Document Reference** | **Classification** | **Type / Suffix** | **Canonical Title** |
| --- | --- | --- | --- |
| `2026-001-meta_spec` | `D` | `meta_spec` | Unified Corpus Meta‑Standard (U‑CMS) |
| `2026-002-spec` | `D` | `spec` | SC‑TPGM — Security Classification & Title‑Page Governance Standard |
| `2026-003-spec` | `D` | `spec` | TST — Technical Standard Template |
| `2026-004-spec` | `D` | `spec` | SV‑GOV — Versioning Governance Standard |
| `2026-005-adr` | `D` | `adr` | ADR‑010 — Suffix Schema Formalization |
| `2026-006-notice` | `D` | `notice` | Contributions Disabled — Corpus Governance Notice |
...
| **Document Reference** | **Classification** | **Type / Suffix** | **Canonical Title** |
| --- | --- | --- | --- |
| `2025-001-paper` | `D` | `paper` | Cognitive Minimalism in Programming: Applying Occam's Razor and Cognitive Load Theory to Software Development Best Practices |
| `2026-001-paper` | `D` | `paper` | The Architecture of Plausibility: Reconceptualising Large Language Models Beyond the Knowledge Base Paradigm |
| `2026-002-paper` | `D` | `paper` | A Multi-Model, Syntax-Preserving, Drift-Resistant Conjecture-to-Proof Pipeline |
| `2026-003-paper` | `D` | `paper` | The First Honest Machine |
| `2026-004-paper` | `D` | `paper` | The Latency–Accuracy Exchange Principle |
| `2026-005-paper` | `D` | `paper` | Prototyping as an Epistemic Taxonomy in Software Systems |
...
| **Document Reference** | **Classification** | **Type / Suffix** | **Canonical Title** |
| --- | --- | --- | --- |
| `2026-001-whitepaper` | `D` | `whitepaper` | Dynamic Island Wallpaper |
...
| **Document Reference** | **Classification** | **Type / Suffix** | **Canonical Title** |
| --- | --- | --- | --- |
| `2026-002-whitepaper` | `D` | `whitepaper` | Risk as a First‑Class Entity in Systems Design |
