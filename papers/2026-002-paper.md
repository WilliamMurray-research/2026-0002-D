...
**Scope:** Defines a disciplined, multi-model, operator-driven epistemic workflow for generating, refining, assessing, and formalizing mathematical and structural conjectures. Establishes protocols for drift-resistance, syntax preservation, structured context handoff, and multi-model verification.

**Primary Model / Scheme:** U‑CMS‑PIPE‑1 (Multi-Model Epistemic Orchestration Model)
